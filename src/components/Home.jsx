...
export const Home = () => {
  return (
    ...
    <div className='text-center mt-10'>
      <p className='text-[#8E8E8E] pb-5'>TrūQoin™ – A Decentralized Autonomous Organization </p>
    </div>
    ...
    <div className='text-center'>
      <p className='text-[#8E8E8E]'>Rewarding activities – that build sustainable growth.</p>
      <button className='mt-7 border border-amber-700 px-18 py-2 rounded-lg hover:border-black duration-300 hover:text-amber-700 text-white'>Get Started</button>
    </div>
    <div className='flex justify-center flex-col items-center mt-30'>
      <h1 className='text-3xl font-bold text-white'>Our Mission</h1>
      <p className='pt-4 text-[#8E8E8E]'>To simplify and normalize the acquisition and use of</p>
    ...
    <div className='text-center text-[#8E8E8E]'>One location – One App for all your digital assets</div>
    </>
  )
}
