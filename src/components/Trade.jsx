...
const About = () => {
  return (
    <>
      <div>
        <div>
          <h1 className="mt-8 flex justify-center text-3xl pb-5 font-semibold text-white">
            About Us
          </h1>
        ...
        <div className="flex-row md:flex justify-between w-[90vw] mx-auto bg-[#343434] px-20 py-10 rounded-2xl mb-30">
          <div>
            <h1 className="text-center text-4xl font-bold pb-5 pt-5 text-white">
              Our Vision
            </h1>
        ...
        <div className="md:flex flex-row justify-between w-[90vw] mx-auto ">
          <div className="pb-10 md:sticky md:top-0 md:h-screen">
            <h1 className="text-3xl font-bold text-white pb-5">
              Why Choose <span className="text-[#EE5A02]">TrūQoin?</span>
            </h1>
          ...
          <div>
            <div
              ...
              className="bg-[#1A1A1A] px-6 py-8 rounded-4xl mb-10 space-y-6 overflow-y-auto"
            >
              ...
              <p className="pb-5 text-white">
                ...
                & Activity™ mining technologies into a cryptocurrency,
                empowering <br />
                miners to acquire tokens without the costs typically associated
                with <br />
        ...
        <div>
          <h1 className="text-white text-4xl text-center pb-10 font-semibold mt-20">
            What We Offer
          </h1>
        </div>
        ...
        <div className="w-[80vw] mx-auto ">
          <div
            style={{
              background:
                "linear-gradient(-100deg,rgba(168, 6, 1, 1) 32%, rgba(238, 90, 2, 1) 79%, rgba(221, 178, 143, 1) 100%)",
            }}
            className="rounded-3xl py-10 text-center"
          >
            <h1 className="text-5xl text-white pb-10">Our People</h1>
            <p className="text-white sm:px-37 px-5">
              The real power of cryptocurrency and digital assets is the
              activity of the people engaged in its creation and use. From
              miners to users, product creators to markers, TrūQoin harnesses
              the energy from everyone involved and creates a stronger, more
              stable and valuable project.
            </p>
